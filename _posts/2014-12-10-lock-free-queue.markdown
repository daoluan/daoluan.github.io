...
[![single_producer_0](http://md.daoluan.net/images/2014/12/single_producer_0.png)](http://md.daoluan.net/images/2014/12/single_producer_0.png)
...
[![single_producer_1](http://md.daoluan.net/images/2014/12/single_producer_1.png)](http://md.daoluan.net/images/2014/12/single_producer_1.png)

当 (front+1)%MAX_QUEUE_SIZE==rear 的时候，队列满了：

[![single_producer_2](http://md.daoluan.net/images/2014/12/single_producer_2.png)](http://md.daoluan.net/images/2014/12/single_producer_2.png)
...
[![single_producer_multi_customers_0](http://md.daoluan.net/images/2014/12/single_producer_multi_customers_0.png)](http://md.daoluan.net/images/2014/12/single_producer_multi_customers_0.png)

先保存旧的 rear ->old_rear，接着拷贝数据，

[![single_producer_multi_customers_1](http://md.daoluan.net/images/2014/12/single_producer_multi_customers_1.png)](http://md.daoluan.net/images/2014/12/single_producer_multi_customers_1.png)

CAS(&rear, old_rear, rear+1)，如果用数组模拟环形数组，考虑越界的情况，

[![single_producer_multi_customers_2](http://md.daoluan.net/images/2014/12/single_producer_multi_customers_2.png)](http://md.daoluan.net/images/2014/12/single_producer_multi_customers_2.png)
...
[![multi_producers_multi_customers_0](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_0.png)](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_0.png)

在入队的时候，保存旧的 write_index -> old_write_index，接着 CAS(&write_index, old_write_index, old_write_index+1). 这一步不成功，需要重复执行。

[![multi_producers_multi_customers_1](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_1.png)](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_1.png)

接着将数据写到对应的位置上，

[![multi_producers_multi_customers_2](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_2.png)](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_2.png)

最后 CAS(&front, old_write_index, old_write_index+1)，直到 CAS 成功为止。这一步不成功，需要重复执行。

[![multi_producers_multi_customers_3](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_3.png)](http://md.daoluan.net/images/2014/12/multi_producers_multi_customers_3.png)
