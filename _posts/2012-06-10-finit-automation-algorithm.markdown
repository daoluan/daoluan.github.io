...
[![image9.png](http://md.daoluan.net/blog/images/2012/06/image9.png)](http://md.daoluan.net/blog/images/2012/06/image9.png)

假定r=alpha(Ta)，那么r<=q+1（条件alpha(T)=q），因为最理想的情况也就是r=q+1（图中的a字符刚好与P的第q+1字符匹配），此时也有r=q+1=alpha[(q)Pa]。

[![image.png](http://md.daoluan.net/blog/images/2012/06/image.png)](http://md.daoluan.net/blog/images/2012/06/image.png)
...
[![image_thumb.png](http://md.daoluan.net/blog/images/2012/06/image_thumb1.png)](http://md.daoluan.net/blog/images/2012/06/image_thumb1.png)
