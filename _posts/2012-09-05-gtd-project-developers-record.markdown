...
[c++ __FILE__，__LINE__和__FUNCTION__的使用方法](http://daoluan.github.io/blog/archives/1095) 在stackoverflow上一个有趣不错的帖子。曾经也在一年前某公司的面试题目遇到这些字眼，可见它可以是c++程序猿基本的素质。__FILE__，__LINE__，__FUNCTION__ 这三个c++内置扩展宏对程序调试非常有好处。日后会尝试着写一个比较通用的c++程序测试工具。
...
[初探libevent网络库](http://daoluan.github.io/blog/archives/1089) libevent是个不错的网络库，后期想按着文章中的思路去开发一个多线程版本。借助libevent，当下的系统已经完成登录模块，万变不离其宗，更新和同步模块随着数据库模型的确定也该尘埃落定。
...
[MySQL入门教程](http://daoluan.github.io/blog/?p=1063) 第三篇报告。前台后台设计如期而至，现正紧张后台数据库测试，兵马未动，粮草先行！
...
[漫谈界面和数据](http://daoluan.github.io/blog/archives/1029) 第二篇报告。

![](http://daoluan.github.io/images/blog/2012/09/UI_data_combine.png)
...
[UIButton 简易UI](http://daoluan.github.io/blog/archives/1006) 第一篇项目报告中的内容抽象绘图按钮，抽象出来过后发现，使用更加灵活。效果图如下：
...
[![](http://daoluan.github.io/images/blog/2012/09/gtd_client.png)](http://daoluan.github.io/blog/archives/975/gtd_client)
...
[![](http://daoluan.github.io/images/blog/2012/09/leader.jpg)](http://daoluan.github.io/blog/archives/975/leader)
...
[![](http://daoluan.github.io/images/blog/2012/09/birds-nest-.jpg)](http://daoluan.github.io/blog/archives/975/birds-nest)
