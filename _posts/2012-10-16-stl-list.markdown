...
[caption id="attachment\_1166" align="aligncenter" width="310"][![](http://daoluan.net/blog/wp-content/uploads/2012/10/list\_node.jpg)](http://daoluan.net/blog/stl-list/list\_node/) list\_node[/caption]
...
list有提供pop\_back,erase,clear,insert等实用的元素操作，不一一复述，给出有用的文档：[http://www.cplusplus.com/reference/stl/list/](http://www.cplusplus.com/reference/stl/list/)
