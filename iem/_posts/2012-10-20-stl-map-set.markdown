...
<div class="wp-caption aligncenter" style="width: 460px"><a href="http://zh.wikipedia.org/wiki/%E7%BA%A2%E9%BB%91%E6%A0%91" onclick="javascript:_gaq.push(['_trackEvent','outbound-article','http://zh.wikipedia.org']);"><img title="RB_TREE" alt="" src="http://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Red-black_tree_example.svg/450px-Red-black_tree_example.svg.png" width="450" height="217"></a><p class="wp-caption-text">红黑树</p></div>
